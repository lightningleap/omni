...
export default function FamilyMatchingBundle({ onOpen }: { onOpen?: () => void }) {
  return (
    <section
      ...
      className="mb-8 flex flex-col gap-3 rounded-[10px] border border-black/[0.06] bg-white/70 p-5 sm:flex-row sm:items-center sm:justify-between"
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-[14px] font-semibold text-[#1A1A1A]">Matching for the whole family</p>
